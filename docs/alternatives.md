...
- AutoHotkey: best free technical proof of concept. It can send key down/up events and repeat loops, but requires scripting and can behave differently in games.
- PowerToys Awake: best option if the only goal is keeping the PC awake.
- PowerToys Keyboard Manager: good for remapping, but not for snapshotting the currently held combo and keeping it held.
