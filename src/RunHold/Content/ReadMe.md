...
- Hold the keys you want RunHold to take over, then press the toggle trigger. The default trigger is Home and can be customized.
...
- Copyright (c) 2026 Hfunball and RunHold contributors.
